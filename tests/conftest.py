...
@pytest.fixture(scope="module",
    params=[
        (
            ...
            'tests/data/Version1/created_version1.csv',
            {
                "488 long": "OrigRNA",
                "Alexa 488": "OrigER",
                "Alexa 568": "OrigAGP",
        ...
        (
            ...
            'tests/data/Version5/created_version5.csv',
             {
        ...
        (
            ...
            'tests/data/Version7/created_version7.csv',
                {
                    "HOECHST 33342": "OrigDNA",
                    "Alexa 568": "OrigAGP",
                    "Alexa 647": "OrigMito",
...
def test_files(request):
    index_directory, index_file, config_file, output_file, created_file, expected_channels = request.param
    test_dict = {'index_directory':index_directory,'index_file':index_file,
                 'config_file':config_file,'output_file':output_file, 'created_file':created_file,
